...
const TRUE = () => true;
const UNTRACKING = { current: false };

/* EXPORT */

export {BATCH, FALSE, IS, NOOP, SUPER_OWNER, OWNER, ROOT, SUSPENSE, SUSPENSE_ENABLED, SYMBOL_OBSERVABLE, SYMBOL_OBSERVABLE_FROZEN, SYMBOL_OBSERVABLE_READABLE, SYMBOL_OBSERVABLE_WRITABLE, SYMBOL_RESOLVE_UNWRAPPED, SYMBOL_STORE, SYMBOL_STORE_OBSERVABLE, SYMBOL_STORE_TARGET, SYMBOL_STORE_VALUES, SYMBOL_SUSPENSE, SYMBOL_UNTRACKED, TRUE, UNTRACKING};
